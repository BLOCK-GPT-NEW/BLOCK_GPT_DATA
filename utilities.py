...
with open(r'C:\zk\BLOCK_GPT_DATA\4byte.json', 'r') as file:
    func_names = json.load(file)

MongoClient_out = pymongo.MongoClient(host="10.12.46.34", port=27017)

# 逐条处理记录
def process_record(batch, queue):
    for record in batch:
        # 读取每一条记录的数据
